...
# backup copy
mkdir $LOGDIR/backupMP1/201906334
...
do
	...
	$PROGCH $ARGS | sort -b > $LOGDIR/log201906334.$TESTN.sorted
done
...
then
	...
	do
		eval ARGS=\${ARGS$TESTN}
		$PROGX $ARGS | sort -b > $LOGDIR/log201906334.$TESTN.sorted

		diff -b $LOGDIR/log201906334.$TESTN.sorted $LOGDIR/log201906334.$TESTN.sorted
	done
fi
